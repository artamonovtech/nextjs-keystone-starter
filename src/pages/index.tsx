  ...
  return (
    ...
    >
      <Head>
        ...
        <meta name="description" content="Example to use Keystone APIs in a Next.js server environment." />
      ...
      <main style={{ display: "flex", justifyContent: "center" }}>
        <section>
          ...
          <ul>
            ...
            <li>
              User.email is behind access control and only visible for logged in users. Once you <strong>log in</strong>
              , you can <strong>see both the name and email</strong> of all users in the database.
            </li>
          </ul>
          ...
          <p>
            Keystone APIs can be seamlessly composed to work as a powerful data engine within Next.js applications
            without having to host a separate Keystone server. This is made possible by Keystone&apos;s `getContext`
            API.
          </p>
          <ul>
            <li>
              <strong>CRUD data within your Next.js server:</strong> You can use the Keystone data APIs directly in
              Next.js `getStaticProps` or `getServerSideProps` to CRUD data. ⚡️
            </li>
            <li>
              <strong>CRUD data from browser:</strong> You can use the generated Keystone GraphQL schema to setup your
              own GraphQL server in a Next.js route. This enables you to send GraphQL requests from the browser. 🤯
            </li>
          </ul>
          <p>
            <em>
              Note: Since you are not starting the keystone server, the Admin UI will not be available. You can host
              Keystone as a separate server if you need Admin UI.
            </em>
          </p>
          <p>
